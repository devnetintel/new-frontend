...
## Overview
This document captures the complete design system for the Personal Network Intelligence (PNI) application, including colors, typography, spacing, components, and all visual details.
...
#### Primary Colors
- **Primary (Teal)**: `hsl(180, 70%, 40%)` - `#14B8A6` (Teal-500)
...
- **Ring/Focus**: `hsl(180, 70%, 40%)` - Primary teal
...
#### Primary Colors
- **Primary (Teal)**: `hsl(180, 70%, 40%)` - `#14B8A6` (Same as light mode)
  - Foreground: `hsl(0, 0%, 100%)` - White

#### Background Colors
- **Background**: `hsl(220, 2%, 10%)` - Dark gray (`#1A1A1A`)
- **Card**: `hsl(220, 2%, 12%)` - Slightly lighter dark gray
- **Muted Background**: `hsl(220, 2%, 18%)` - Medium dark gray

#### Text Colors
- **Foreground**: `hsl(0, 0%, 95%)` - Off-white
- **Muted Foreground**: `hsl(220, 5%, 60%)` - Light gray
- **Card Foreground**: `hsl(0, 0%, 95%)` - Off-white

#### Border Colors
- **Border**: `hsl(220, 2%, 18%)` - Medium dark gray
- **Input Border**: `hsl(220, 2%, 18%)` - Medium dark gray
- **Ring/Focus**: `hsl(180, 70%, 40%)` - Primary teal

#### Semantic Colors
- **Destructive**: `hsl(0, 62.8%, 30.6%)` - Dark red
- **Destructive Foreground**: `hsl(0, 0%, 98%)` - Off-white
- **Secondary**: `hsl(220, 2%, 18%)` - Medium dark gray
- **Accent**: `hsl(220, 2%, 18%)` - Medium dark gray
...
- **Primary Action**: `#667eea` - Indigo/Purple
- **Indigo Primary**: `#4f46e5` - `bg-indigo-600`

### Workspace Network Colors
- **Blue**: `bg-blue-500/10`, `border-blue-500/50`, `text-blue-400`, `bg-blue-500`
- **Green**: `bg-green-500/10`, `border-green-500/50`, `text-green-400`, `bg-green-500`
- **Purple**: `bg-purple-500/10`, `border-purple-500/50`, `text-purple-400`, `bg-purple-500`
...
- **Primary Teal**: `text-primary` (theme-aware)
...
- **Glow Effect**: `shadow-[0_0_10px_rgba(20,184,166,0.2)]` - Teal glow (active sidebar items)
- **Workspace Selected**: `shadow-[0_0_15px_rgba(59,130,246,0.15)]` - Blue glow
...
- **Refresh Button**: `bg-[#667eea]` (admin) / `bg-indigo-600` (admin database)
...
- **Selected State**:
  - Background: Color-specific with 10% opacity (`bg-blue-500/10`, etc.)
  - Border: Color-specific with 50% opacity (`border-blue-500/50`, etc.)
  - Text: Color-specific (`text-blue-400`, etc.)
...
- **Border Radius**: `rounded-full`
- **Background**: `bg-blue-500/10` (example)
- **Text**: `text-blue-400` (example)
- **Border**: `border border-blue-500/20` (example)
...
### Active States
- **Sidebar Active**: `bg-primary/10 text-primary opacity-100 shadow-[0_0_10px_rgba(20,184,166,0.2)]`
...
- **Send (With Text)**: `bg-primary text-primary-foreground`
...
- **Spinner**: Teal color, `animate-spin`
...
- **Selected Table**: `bg-indigo-600 text-white`
...
- Primary teal on white: High contrast
...
- **Custom Colors**: `#667eea` (admin primary), `#14B8A6` (primary teal)
...
This design system ensures consistency across the entire application while maintaining flexibility for theme switching and responsive design.
