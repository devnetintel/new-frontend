...
function JoinPageContent() {
    ...
    useEffect(() => {
        if (refCode && refCode !== "default") {
            localStorage.setItem("pending_workspace", refCode);
            console.log("📌 Velvet Rope: Captured referral:", refCode);
        }
    }, [refCode]);
                ...
                <div className="space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-lg text-zinc-400 leading-relaxed">
                            You have been granted access to my personal network intelligence. Use the search to find founders, investors, and talent.
                        </p>
                    </div>
