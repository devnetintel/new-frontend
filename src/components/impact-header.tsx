...
export function ImpactHeader({ connectionsMade, activeRequests, userName }: ImpactHeaderProps) {
    return (
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        You&apos;re the bridge for <span className="font-medium text-foreground">{connectionsMade + activeRequests} potential connections</span> this month.
                    </p>
                </div>
            </div>
